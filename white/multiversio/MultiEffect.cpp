...
int main(void)
{
    ...
    filter_cutoff_l_par.Init(versio.knob[KNOB_0], 60, 20000, filter_cutoff_l_par.LOGARITHMIC);
    filter_cutoff_r_par.Init(versio.knob[KNOB_4], 60, 20000, filter_cutoff_r_par.LOGARITHMIC);

    delay_cutoff_par.Init(versio.knob[KNOB_1], 400, 20000, delay_cutoff_par.LOGARITHMIC);
    ...
    lofi_tone_par.Init(versio.knob[KNOB_2], 20, 20000, lofi_tone_par.LOGARITHMIC);
    lofi_rate_par.Init(versio.knob[KNOB_1], sample_rate*4, sample_rate/16, lofi_rate_par.LOGARITHMIC);
...
{  
    float blend = versio.GetKnobValue(KNOB_0);
    float speed = versio.GetKnobValue(KNOB_1); 
    float tone = versio.GetKnobValue(KNOB_2);
    float index = versio.GetKnobValue(KNOB_3);
    float regen = versio.GetKnobValue(KNOB_4); 
    float size = versio.GetKnobValue(KNOB_5);
    float dense = versio.GetKnobValue(KNOB_6);
