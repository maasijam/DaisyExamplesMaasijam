#pragma once
#ifndef DSY_SWITCHHANK_H
#define DSY_SWITCHHANK_H
...
class SwitchHank
{
  public:
    ...
    */
    void
    Init(dsy_gpio_pin pin, float update_rate,long doubleclickTime, Type t, Polarity pol, Pull pu);
    ...
    */
    void Init(dsy_gpio_pin pin, float update_rate = 0.f, long doubleclickTime = 250);
  ...
  private:
    ...
    float    first_rising_edge_time_;
    int clickCount_;             // Number of button clicks within multiclickTime milliseconds
    bool doubleclicked_;
