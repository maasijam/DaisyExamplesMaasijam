...
int main(void)
{
    ...
    while(1)
    {
        ...
        decimator_l.SetBitcrushFactor(hw.GetKnobValue(DaisyVertigo::KNOB_0));
        decimator_l.SetDownsampleFactor(hw.GetKnobValue(DaisyVertigo::KNOB_1));

        decimator_r.SetBitcrushFactor(hw.GetKnobValue(DaisyVertigo::KNOB_2));
        decimator_r.SetDownsampleFactor(hw.GetKnobValue(DaisyVertigo::KNOB_3));

        kval = hw.GetKnobValue(DaisyVertigo::KNOB_6);
    }
}
